...
uplink-gloves-knuckleduster-desc = Пара пластитановых кастетов, которые позволяют нанести удар достаточно сильный, чтобы разбить челюсть шерифа вдребезги.
...
uplink-syndicate-segway-crate-desc = Способ повысить вашу мобильность при захвате аванпоста ДСБФ.
